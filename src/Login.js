        ...
        <div className='login'>
            ...
            <div className='login__container'>
                ...
                <form>
                    ...
                    <button type='submit' onClick={signIn} className='login__signInButton'>Anmeldung</button>
                </form>

                <p>
                    Mit Ihrer Anmeldung stimmen Sie den DABBAVELO DEMO -WEB  Nutzungsbedingungen und Verkaufsbedingungen zu. por favor
                    Weitere Informationen finden Sie in unserer Datenschutzerklärung, unserer Cookie-Mitteilung und unserer Mitteilung über interessenbezogene Anzeigen.


                </p>

                <button onClick={register} className='login__registerButton'>Konto in DABBAVELO erstellen</button>
            </div>
        </div>
    )
}
